...
//支付渠道
Pay.CHARGEARR = [
    {sum: 21, list: {title: "网银支付", text: "Online payment", type: "5", url: "/Recharge", icon: "x-icon x-icon-Online", scancode: ''}},
    {sum: 22, list: {title: "扫码支付", text: "Scan Code", type: "66", url: "/scancode", icon: "x-icon x-icon-ScanCode", scancode: ''}},
    {sum: 23, list: {title: "微信支付", text: "Wechat transfer", type: "7", url: "/Recharge", icon: "x-icon x-icon-wechat", scancode: 'wx'}},
    {sum: 24, list: {title: "支付宝支付", text: "Alipay transfer", type: "6", url: "/Recharge", icon: "x-icon x-icon-Alipay", scancode: 'ali'}},
    {sum: 25, list: {title: "财付通支付", text: "TenPay transfer", type: "8", url: "/Recharge", icon: "x-icon x-icon-tenpay", scancode: 'cft'}},
    {sum: 26, list: {title: "京东支付", text: "Jingdong pay", type: "12", url: "/Recharge", icon: "x-icon x-icon-jd", scancode: 'jd'}},
    {sum: 27, list: {title: "银联扫码", text: "UnionPay Code", type: "10", url: "/Recharge", icon: "x-icon x-icon-ylsm", scancode: 'yl'}},
    {sum: 28, list: {title: "银行汇款", text: "Bank tranfer", type: "44", url: "/information", icon: "x-icon x-icon-Banktranfer", scancode: ''}},
    {sum: 29, list: {title: "快捷支付", text: "Quick payment", type: "14", url: "/Recharge", icon: "x-icon x-icon-kj", scancode: 'kj'}},
